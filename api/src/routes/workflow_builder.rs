...
fn sap_import_descriptor() -> WorkflowStageDescriptor {
    ...
    WorkflowStageDescriptor {
        ...
        editable_fields: vec![WorkflowStageFieldGroup {
            ...
            label: "SAP Import".to_string(),
            fields: vec![
                text_field("package_name", "Package name", "capabilities.sap/import.package_name", ""),
                bool_field("include_subpackages", "Include subpackages", "capabilities.sap/import.include_subpackages", true),
            ],
        }],
...
fn sap_export_descriptor() -> WorkflowStageDescriptor {
    ...
    WorkflowStageDescriptor {
        ...
        editable_fields: vec![WorkflowStageFieldGroup {
            ...
            label: "SAP Export".to_string(),
            fields: vec![
                text_field("manifest_paths_text", "Manifest paths", "capabilities.sap/export.manifest_paths_text", ""),
                bool_field("auto_activate", "Auto activate", "capabilities.sap/export.auto_activate", true),
                text_field("corr_nr", "Transport request", "capabilities.sap/export.corr_nr", ""),
            ],
        }],
